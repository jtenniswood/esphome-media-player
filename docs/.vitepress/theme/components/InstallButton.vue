...
const allDevices = [
  ...
  { key: 'p4-86-panel', label: 'Waveshare ESP32-P4 86 Panel (4")', manifest: 'media-player-p4-86-panel.manifest.json' },
  { key: 'jc4880p443', label: 'Guition ESP32-P4 JC4880P443 (4.3")', manifest: 'media-player-jc4880p443.manifest.json' },
