...
This profile includes a small horizontal visual correction for the JC1060P470 panel. Text, play/pause controls, and volume controls are drawn 5% narrower so they look closer to their real shape on the physical screen. Artwork is left unscaled so full-screen image changes stay responsive.
